...
package com.zelering.AdReader.SampleApplication;
...
public class SampleApplicationSession implements UpdateCallbackInterface {
    ...
    private static final String LOGTAG = "V_S_Applications";
    ...
    public SampleApplicationSession(SampleApplicationControl sessionControl, String Vufori_lic_key) {
        mSessionControl = sessionControl;
        vuforia_lic_key = Vufori_lic_key;
    }
