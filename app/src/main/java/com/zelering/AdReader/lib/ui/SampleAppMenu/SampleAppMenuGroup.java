...
package com.zelering.AdReader.lib.ui.SampleAppMenu;
...
public class SampleAppMenuGroup
{
        ...
        int width)
    {
        ...
        mLayout = (LinearLayout) inflater.inflate(
            com.zelering.AdReader.lib.R.layout.sample_app_menu_group, null, false);
        mLayout.setLayoutParams(new LinearLayout.LayoutParams(width,
            LinearLayout.LayoutParams.WRAP_CONTENT));
        
        mEntriesTextSize = mActivity.getResources().getDimension(
            com.zelering.AdReader.lib.R.dimen.menu_entries_text);
        
        mEntriesSidesPadding = (int) mActivity.getResources().getDimension(
            com.zelering.AdReader.lib.R.dimen.menu_entries_sides_padding);
        mEntriesUpDownPadding = (int) mActivity.getResources().getDimension(
            com.zelering.AdReader.lib.R.dimen.menu_entries_top_down_padding);
        mEntriesUpDownRadioPadding = (int) mActivity.getResources()
            .getDimension(com.zelering.AdReader.lib.R.dimen.menu_entries_top_down_radio_padding);
        dividerResource = com.zelering.AdReader.lib.R.layout.sample_app_menu_group_divider;
        ...
        TextView titleView = (TextView) mLayout
            .findViewById(com.zelering.AdReader.lib.R.id.menu_group_title);
        titleView.setText(title);
        titleView.setTextSize(mActivity.getResources().getDimension(
            com.zelering.AdReader.lib.R.dimen.menu_entries_title));
        ...
        if (!hasTitle)
        {
            ...
            View dividerView = mLayout
                .findViewById(com.zelering.AdReader.lib.R.id.menu_group_title_divider);
    ...
    public View addRadioItem(String text, int command, boolean isSelected)
    {
        ...
        RadioButton newRadioButton = (RadioButton) inflater.inflate(
            com.zelering.AdReader.lib.R.layout.sample_app_menu_group_radio_button, null, false);
